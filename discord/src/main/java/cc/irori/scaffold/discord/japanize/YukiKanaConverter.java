/*
 * This file contains code derived from the LunaChat project.
 * Original Copyright (c) ucchyocean and LunaChat contributors.
 * Licensed under the GNU Lesser General Public License version 3.0.
 *
 * Integrated into scaffold under the AGPL-3.0 compatibility
 * provision of LGPL-3.0 Section 13.
 */
package cc.irori.scaffold.discord.japanize;
